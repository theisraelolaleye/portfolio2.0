...
//  URL SHORTENER 
 ...
 // jobfrica 
  ...
  // phishcatch 
  {
    ...
    title: "PhishCatch",
    description:
      "Check if a link is phishing with instant verdicts.",
    longDescription:
      "PhishCatch helps users quickly evaluate URLs for phishing indicators. Paste a link to get risk signals and guidance, built with Next.js and a clean, responsive UI.",
    image: "/projects/PhischCatch.png",
    tags: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Security"],
    liveUrl: "https://phishcatch.vercel.app/",
    featured: true,
    category: "web",
  },
];
